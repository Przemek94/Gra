...
public class Pytanie100 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie100);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie100);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie100.class);
