...
public class Pytanie68 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie68);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie68);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie69.class);
