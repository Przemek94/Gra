...
public class Pytanie22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie22);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie22);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie23.class);
