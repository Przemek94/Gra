...
public class Pytanie92 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie92);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie92);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie93.class);
