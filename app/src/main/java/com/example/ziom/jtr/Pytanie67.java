...
public class Pytanie67 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie67);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie67);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie68.class);
