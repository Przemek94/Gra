...
public class Pytanie14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie14);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie14);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie15.class);
