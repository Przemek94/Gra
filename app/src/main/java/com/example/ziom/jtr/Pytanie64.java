...
public class Pytanie64 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie64);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie64);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie65.class);
