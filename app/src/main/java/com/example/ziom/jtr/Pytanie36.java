...
public class Pytanie36 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie36);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie36);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie37.class);
