...
public class Pytanie27 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie27);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie27);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie28.class);
