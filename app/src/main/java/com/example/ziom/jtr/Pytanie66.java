...
public class Pytanie66 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie66);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie66);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie67.class);
