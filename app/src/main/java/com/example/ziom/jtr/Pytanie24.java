...
public class Pytanie24 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie24);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie24);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie25.class);
