...
public class Pytanie47 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie47);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie47);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie48.class);
