...
public class Pytanie76 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie76);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie76);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie77.class);
