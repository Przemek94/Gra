...
public class Pytanie83 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie83);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie83);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie84.class);
