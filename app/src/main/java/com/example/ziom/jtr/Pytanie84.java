...
public class Pytanie84 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie84);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie84);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie85.class);
