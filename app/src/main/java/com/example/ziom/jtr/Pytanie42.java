...
public class Pytanie42 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie42);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie42);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie43.class);
