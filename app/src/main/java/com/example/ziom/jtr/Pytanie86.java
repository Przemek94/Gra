...
public class Pytanie86 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie86);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie86);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie87.class);
