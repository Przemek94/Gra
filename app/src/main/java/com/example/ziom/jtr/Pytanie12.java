...
public class Pytanie12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie12);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie12);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie13.class);
