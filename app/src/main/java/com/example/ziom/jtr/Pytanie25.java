...
public class Pytanie25 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie25);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie25);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie26.class);
