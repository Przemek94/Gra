...
public class Pytanie21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie21);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie21);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie22.class);
