...
public class Pytanie43 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie43);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie43);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie44.class);
