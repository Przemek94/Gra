...
public class Pytanie29 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie29);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie29);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie30.class);
