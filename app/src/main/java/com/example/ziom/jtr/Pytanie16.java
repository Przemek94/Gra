...
public class Pytanie16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie16);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie16);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie17.class);
