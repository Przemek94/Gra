...
public class Pytanie93 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie93);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie93);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie94.class);
