...
public class Pytanie6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie6);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie6);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie7.class);
