...
public class Pytanie23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie23);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie23);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie24.class);
