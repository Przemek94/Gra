...
public class Pytanie33 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie33);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie33);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie34.class);
