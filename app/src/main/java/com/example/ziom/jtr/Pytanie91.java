...
public class Pytanie91 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie91);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie91);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie92.class);
