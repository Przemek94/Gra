...
public class Pytanie85 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie85);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie85);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie86.class);
