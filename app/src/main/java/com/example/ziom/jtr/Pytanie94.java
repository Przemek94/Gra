...
public class Pytanie94 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie94);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie94);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie95.class);
