...
public class Pytanie40 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie40);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie40);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie41.class);
