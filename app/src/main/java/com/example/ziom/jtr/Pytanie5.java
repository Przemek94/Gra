...
public class Pytanie5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie5);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie5);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie6.class);
