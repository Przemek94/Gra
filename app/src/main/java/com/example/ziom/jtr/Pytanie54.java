...
public class Pytanie54 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie54);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie54);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie54.class);
