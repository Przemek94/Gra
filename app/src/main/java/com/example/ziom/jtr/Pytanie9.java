...
public class Pytanie9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie9);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie9);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie10.class);
