...
public class Pytanie65 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie65);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie65);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie66.class);
