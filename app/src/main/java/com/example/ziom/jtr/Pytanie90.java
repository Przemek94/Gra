...
public class Pytanie90 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie90);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie90);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie91.class);
