...
public class Pytanie97 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie97);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie97);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie98.class);
