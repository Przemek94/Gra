...
public class Pytanie58 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie58);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie58);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie59.class);
