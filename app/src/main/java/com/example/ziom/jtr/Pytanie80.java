...
public class Pytanie80 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie80);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie80);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie81.class);
