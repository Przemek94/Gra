...
public class Pytanie34 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie34);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie34);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie35.class);
