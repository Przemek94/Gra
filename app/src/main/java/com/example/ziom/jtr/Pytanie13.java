...
public class Pytanie13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie13);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie13);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie14.class);
