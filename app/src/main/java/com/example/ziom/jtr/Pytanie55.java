...
public class Pytanie55 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie55);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie55);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie56.class);
