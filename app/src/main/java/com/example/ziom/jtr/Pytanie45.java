...
public class Pytanie45 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie45);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie45);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie46.class);
