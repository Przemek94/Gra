...
public class Pytanie95 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie95);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie95);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie96.class);
