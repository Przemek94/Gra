...
public class Pytanie81 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie81);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie81);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie82.class);
