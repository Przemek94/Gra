...
public class Pytanie26 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie26);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie26);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie27.class);
