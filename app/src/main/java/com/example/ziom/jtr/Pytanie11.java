...
public class Pytanie11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie11);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie11);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie12.class);
