...
public class Pytanie78 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie78);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie78);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie79.class);
