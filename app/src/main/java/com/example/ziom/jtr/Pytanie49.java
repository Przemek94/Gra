...
public class Pytanie49 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie49);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie49);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie50.class);
