...
public class Pytanie77 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie77);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie77);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie78.class);
