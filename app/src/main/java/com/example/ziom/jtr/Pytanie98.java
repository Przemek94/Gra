...
public class Pytanie98 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie98);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie98);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie99.class);
