...
public class Pytanie56 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie56);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie56);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie57.class);
