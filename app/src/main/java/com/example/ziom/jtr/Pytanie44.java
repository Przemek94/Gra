...
public class Pytanie44 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie44);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie44);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie45.class);
