...
public class Pytanie69 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pytanie69);
        ...
        pytanie = MediaPlayer.create(this, R.raw.pytanie69);
        pytanie.start();
    ...
    public void Dalej(View view) {
        Intent intent = new Intent(this, Pytanie70.class);
